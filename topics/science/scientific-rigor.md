# Working philosophy of scientific reasoning
*More than individual facts, these are the rules to now carry forward when discussing science.*

### 1. The design question comes before the statistics

Before asking whether a result is significant, powerful, replicated, etc., ask:

> **Can this experimental design actually answer the question being asked?**
...
This is probably the most important distinction established.

Exploratory work can:

- reveal an unexpected pattern,
- suggest variables worth investigating,
- generate hypotheses,
- estimate effect sizes,
- tell us what experiment to conduct next.

But evidence used to **generate** a hypothesis cannot simply be turned around and treated as independent confirmation of that hypothesis.
...
A mosquito/blood-type discussion gave a particularly good example.
...
If mosquito species could interact differently with the factor being tested, for example, then combining species may make it impossible to know what biological phenomenon produced the aggregate result—even with an impressive regression afterward.

There are situations where multivariable designs are exactly appropriate, but complexity needs to serve the research question rather than curiosity.

### 6. Imperfect evidence can still be genuinely scientific evidence

It is important to also push against the opposite mistake: treating anything short of an ideal randomized experiment as epistemically useless.

Natural experiments, proxies, opportunistic observations, retrospective datasets, historical accidents, and imperfect measurements can all contribute real knowledge.
...
> "It supports my story, therefore it proves it."

Scope the inference to the evidence.

### 7. Philosophy is already inside science

An evolutionary-biology discussion sharpened this one.

Scientists inevitably make conceptual decisions about things such as:

- what constitutes the same trait,
- what counts as an independent origin,
- what level of organization matters,
- which organisms belong in the comparison class,
...
### 8. Words like *purpose*, *design*, and even *convergence* can quietly do explanatory work

Biologists can use purpose-like language perfectly productively because everyone in the field understands its restricted meaning.
...
And the three independently evolved biological flagellar systems gave us an unusually clean example: "flagellum" describes a functional/morphological similarity while concealing radically different underlying machinery.

### 9. Non-convergence itself demands explanation
...
> **"Given similar problems, why did all the others remain different?"**

### 10. Comparison depends on scope
...
- locating relationships across disciplines,
...
- Are exploratory and confirmatory analyses being mixed?
- Is a comparison class coherent?
- Are causal claims exceeding the design?
- Has an operational definition quietly changed?
- Is a statistical result being asked to carry conceptual weight it cannot carry?

And even such a model would require trained users. A model agreeing with a correction does **not** demonstrate that the correction was correct. The correction itself remains subject to scrutiny.
